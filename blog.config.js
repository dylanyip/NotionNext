...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'DylanStudio', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个勤于思考的保守主义臭知识分子', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://dylanstudio.com', // 网站地址
